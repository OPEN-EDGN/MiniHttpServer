...
import tech.openEdgn.netServer.webServer.thread.ServerSocketRunnable
import tech.openEdgn.netServer.webServer.utils.WebLoggerConfig
...
class WebServer @JvmOverloads constructor(
    ...
    // HTTP 端口绑定套接字
    private val serverSocketRunnable by lazy { ServerSocketRunnable(serverSocket, webConfig) }
    //
